...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-z+p93c7i1tp$3tv9^oj!-4x1p9^@^=9rm41(_6fnmdr-i&^#oe')
...
# If you're using PostgreSQL, you might want to update it like this:
# DATABASES = {
#     'default': {
...
# Email settings (if you're using email)
